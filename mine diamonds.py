...
player1=Button(root,text="Player 1",command=player1,image=img)
player1.place(relx=0.1,rely=0.7,anchor=CENTER)

player2=Button(root,text="Player 2",command=player2,image=img)
player2.place(relx=0.9,rely=0.7,anchor=CENTER)

player1l = Label(root,text="Player 1")
player1l.place(relx=0.1,rely=0.4,anchor=CENTER)

player2l = Label(root,text="Player 2")
player2l.place(relx=0.9,rely=0.4,anchor=CENTER)
